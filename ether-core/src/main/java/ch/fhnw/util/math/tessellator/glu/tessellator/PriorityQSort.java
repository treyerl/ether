...
class PriorityQSort extends PriorityQ {
    ...
    PriorityQSort(final PriorityQ.Leq leq) {
...
/* really __gl_pqSortDeletePriorityQ */
    ...
    private static boolean LT(final PriorityQ.Leq leq, final Object x, final Object y) {
        return (!PriorityQ.LEQ(leq, y, x));
    }

    private static boolean GT(final PriorityQ.Leq leq, final Object x, final Object y) {
