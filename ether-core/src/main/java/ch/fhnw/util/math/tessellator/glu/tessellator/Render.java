...
*/
package ch.fhnw.util.math.tessellator.glu.tessellator;
 ...
 */
    private static class FaceCount {
        ...
        FaceCount(final long size, final GLUhalfEdge eStart, final RenderCallBack render) {
            this.size = size;
            this.eStart = eStart;
            this.render = render;
        }
 ...
 */
    static void __gl_renderMesh(final GLUtessellatorImpl tess, final GLUmesh mesh) {
        GLUface f;
 ...
 */
    ...
    static void RenderLonelyTriangles(final GLUtessellatorImpl tess, GLUface f) {
        ...
        tess.callBeginOrBeginData(GLU.GL_TRIANGLES);
    ...
    private static class RenderFan implements RenderCallBack {
        ...
        public void render(final GLUtessellatorImpl tess, GLUhalfEdge e, long size) {
             ...
             */
            tess.callBeginOrBeginData( GLU.GL_TRIANGLE_FAN);
            tess.callVertexOrVertexData( e.Org.data);
    ...
    private static class RenderStrip implements RenderCallBack {
        ...
        public void render(final GLUtessellatorImpl tess, GLUhalfEdge e, long size) {
             ...
             * (otherwise we've goofed up somewhere).
             */
            tess.callBeginOrBeginData( GLU.GL_TRIANGLE_STRIP);
            tess.callVertexOrVertexData( e.Org.data);
            tess.callVertexOrVertexData( e.Sym.Org.data);
 ...
 */
    static void __gl_renderBoundary(final GLUtessellatorImpl tess, final GLUmesh mesh) {
        GLUface f;
        GLUhalfEdge e;

        for (f = mesh.fHead.next; f != mesh.fHead; f = f.next) {
            if (f.inside) {
                tess.callBeginOrBeginData( GLU.GL_LINE_LOOP);
                e = f.anEdge;
                do {
                    tess.callVertexOrVertexData( e.Org.data);
                    e = e.Lnext;
 ...
 */
    static boolean __gl_renderCache(final GLUtessellatorImpl tess) {
        final CachedVertex[] v = tess.cache;
//            CachedVertex vn = v0 + tess.cacheCount;
        final int vn = tess.cacheCount;
//            CachedVertex vc;
        ...
        if ( !USE_OPTIMIZED_CODE_PATH ) {
            ...
            tess.callBeginOrBeginData( tess.boundaryOnly ? GLU.GL_LINE_LOOP
                    : (tess.cacheCount > 3) ? GLU.GL_TRIANGLE_FAN
                    : GLU.GL_TRIANGLES);
