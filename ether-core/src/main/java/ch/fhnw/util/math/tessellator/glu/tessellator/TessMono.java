 ...
 * must be monotone.
 */
    static boolean __gl_meshTessellateInterior(final GLUmesh mesh, final boolean avoidDegenerateTris) {
        GLUface f, next;
 ...
 */
    static void __gl_meshDiscardExterior(final GLUmesh mesh) {
        GLUface f, next;
 ...
 */
    static boolean __gl_meshSetWindingNumber(final GLUmesh mesh, final int value, final boolean keepOnlyBoundary) {
        GLUhalfEdge e, eNext;
