...
public interface GLUtessellatorCallback {
	/**
	 * The <b>begin</b> callback method is invoked like glBegin to indicate the
	 * start of a (triangle) primitive. The method takes a single argument of
	 * type int. If the <b>GLU_TESS_BOUNDARY_ONLY</b> property is set to
	 ...
	 * then the argument will be set to <b>GL_LINE_LOOP</b>.
	 *
	 * @param type
	 ...
	 * opaque reference provided when {@link GLU#gluTessBeginPolygon
	 ...
	 * takes a single boolean boundaryEdge that indicates which edges lie on the
	 ...
	 * the opaque reference provided when {@link GLU#gluTessBeginPolygon
	 * gluTessBeginPolygon} was called.
	 *
	 * @param boundaryEdge
	 *            Specifics which edges lie on the polygon boundary.
	 ...
	 * glVertex3f, and it defines the vertices of the triangles created by the
	 * tessellation process. The method takes a reference as its only argument.
	 * This reference is identical to the opaque reference provided by the user
	 * when the vertex was described (see {@link GLU#gluTessVertex
	 * gluTessVertex}).
	 *
	 * @param vertexData
	 ...
	 * of a primitive and it takes no arguments.
	 *
	 * @see GLU#gluTessCallback gluTessCallback
	 * @see #begin begin
	 * @see #endData endData
	 ...
	 * reference provided when {@link GLU#gluTessBeginPolygon
	 * gluTessBeginPolygon} was called.
	 *
	 * @param polygonData
	 *            Specifics a reference to user-defined data.
	 ...
	 * {@link GLU#gluTessEndPolygon gluTessEndPolygon} is called.
	 * <P>
	 *
