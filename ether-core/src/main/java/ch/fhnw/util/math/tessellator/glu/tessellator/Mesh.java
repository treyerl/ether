 ...
 */
    static void MakeVertex(final GLUvertex newVertex,
                           final GLUhalfEdge eOrig, final GLUvertex vNext) {
        GLUhalfEdge e;
        GLUvertex vPrev;
 ...
 */
    static void KillVertex(final GLUvertex vDel, final GLUvertex newOrg) {
        GLUhalfEdge e;
        final GLUhalfEdge eStart = vDel.anEdge;
 ...
 */
    static void KillFace(final GLUface fDel, final GLUface newLface) {
        GLUhalfEdge e;
        final GLUhalfEdge eStart = fDel.anEdge;
        GLUface fPrev, fNext;
 ...
 */
    static GLUhalfEdge __gl_meshMakeEdge(final GLUmesh mesh) {
 ...
 */
    static boolean __gl_meshSplice(final GLUhalfEdge eOrg, final GLUhalfEdge eDst) {
 ...
 * eOrg and eNew will have the same left face.
 */
    static GLUhalfEdge __gl_meshSplitEdge(final GLUhalfEdge eOrg) {
        GLUhalfEdge eNew;
...
/* __gl_meshDeleteMesh( mesh ) will free all storage for any valid mesh.
 */
    static void __gl_meshDeleteMesh(final GLUmesh mesh) {
        GLUface f, fNext;
        GLUvertex v, vNext;
        GLUhalfEdge e, eNext;
 ...
 */
    static void __gl_meshCheckMesh(final GLUmesh mesh) {
        final GLUface fHead = mesh.fHead;
