...
/* really __gl_pqHeapNewPriorityQ */
    PriorityQHeap(final PriorityQ.Leq leq) {
        size = 0;
...
/* really __gl_pqHeapDeletePriorityQ */
    ...
    void FloatDown(int curr) {
        final PriorityQ.PQnode[] n = nodes;
        final PriorityQ.PQhandleElem[] h = handles;
        int hCurr, hChild;
        int child;
...
/* returns LONG_MAX iff out of memory */
    ...
    int pqInsert(final Object keyNew) {
        ...
        curr = ++size;
        if ((curr * 2) > max) {
            //final PriorityQ.PQnode[] saveNodes = nodes;
            //final PriorityQ.PQhandleElem[] saveHandles = handles;
