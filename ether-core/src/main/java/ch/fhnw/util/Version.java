...
public class Version {
	...
	public static VisualStyle getVisualStyle() {
		...
		if (laf.getClass().getName().endsWith("WindowsLookAndFeel") && !(laf.getClass().getName().endsWith("WindowsClassicLookAndFeel"))) {
			...
			if(dllName.toLowerCase().contains("aero"))
				return VisualStyle.AERO;
		}
