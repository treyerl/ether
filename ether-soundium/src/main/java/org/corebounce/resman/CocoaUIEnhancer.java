...
public class CocoaUIEnhancer {
	...
	public static class ActionProc {
		final IAction aboutAction;
		final IAction preferencesAction;

		public ActionProc(IAction aboutAction, IAction preferencesAction) {
	 ...
	 */
	public void hookApplicationMenu( Display display, IAction aboutAction, IAction preferencesAction ) {
		...
		try {
			...
			initialize( new ActionProc(aboutAction, preferencesAction) );
		} catch ( Throwable e ) {
			log.warning(e);
		}
